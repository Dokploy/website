...
<ImageZoom src="/assets/images/ui/create-custom-role.webp" alt="Create Custom Role modal with permission presets and granular toggles" width={1600} height={775} className="rounded-lg"/>
