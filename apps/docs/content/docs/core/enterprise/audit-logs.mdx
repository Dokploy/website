...
<ImageZoom src="/assets/images/ui/settings-audit-logs.webp" alt="Audit Logs with filterable table of all actions" width={1600} height={775} className="rounded-lg"/>
