...
<ImageZoom src="/assets/images/ui/settings-sso.webp" alt="SSO providers in Settings" width={1600} height={775} className="rounded-lg"/>

<ImageZoom src="/assets/images/ui/sso-add-oidc-provider.webp" alt="Add OIDC provider modal" width={1600} height={775} className="rounded-lg"/>
