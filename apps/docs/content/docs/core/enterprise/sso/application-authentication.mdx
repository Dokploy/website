...
<ImageZoom src="/assets/images/ui/application-authentication.webp" alt="Application Authentication configuration under Settings > SSO" width={1600} height={775} className="rounded-lg"/>
