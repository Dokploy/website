...
<ImageZoom src="/assets/images/preview-deployments.webp" width={800} height={630} alt='Preview deployments' className="rounded-lg" />
...
<ImageZoom src="/assets/images/preview-deploy.webp" width={800} height={630} alt='Preview deployments build' className="rounded-lg" />
