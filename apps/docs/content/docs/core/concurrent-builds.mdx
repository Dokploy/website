...
<ImageZoom src="/assets/images/ui/concurrent-builds.webp" alt="Per-server concurrency configuration under Settings > Deployments" width={1600} height={775} className="rounded-lg"/>
