...
![Docker compose configuration](/assets/images/compose/setup.webp)
...
<ImageZoom  src="/assets/images/compose/domain.webp" width={800} height={630} alt='home og image' className="rounded-lg" />
...
<ImageZoom  src="/assets/images/compose/application.webp" width={800} height={630} alt='home og image' className="rounded-lg" />
