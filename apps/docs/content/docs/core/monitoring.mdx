...
<ImageZoom src="/monitoring.webp" alt="Architecture Diagram" width={1000} height={600} className="rounded-lg"/>

For your services you should see something like this:
<ImageZoom src="/monitoring-services.webp" alt="Architecture Diagram" width={1000} height={600} className="rounded-lg"/>
