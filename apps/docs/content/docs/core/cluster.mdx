...
<ImageZoom src="/assets/docker-swarm.webp" alt="Docker Swarm Diagram" width={1000} height={600} className="rounded-lg"/>
...
<ImageZoom src="/assets/add-node.webp" alt="Add Node" width={800} height={630} className="rounded-lg"/>

Once you follow the instructions, the workers or managers will appear in the table.

<ImageZoom src="/assets/nodes.webp" alt="View Nodes" width={800} height={630} className="rounded-lg"/>
